    ...
    return (
        <div className="2xl:mx-auto 2xl:container mx-4 py-6">
            <div className=" w-full  relative flex items-center justify-center">
                ...
                <div className="bg-gray-800 bg-opacity-80 md:my-16 text-white lg:py-16 py-10 w-full md:mx-24 md:px-12 px-4 flex flex-col items-center justify-center relative z-40">
